        ...
        <SectionIntro class="max-w-5xl">
          <template #title>
            ...
            >
              ...
              offre une sensation de liberté absolue, alliant luxe discret et
              confort total.
            </span>
          </template>
        </SectionIntro>
          ...
          >
            <div>
              ...
              <p class="mt-8">
                ...
                croisée et d’un accès direct aux terrasses opposées, tandis que
                les chambres, parfaitement disposées, donnent toutes sur le
                jardin pour plus d'intimité.
              </p>
            </div>
            <div>
              <p>
                Le design des villas divise les espaces de manière intuitive :
                les chambres et la cuisine sont isolées du salon, permettant une
                fonctionnalité optimale. Chaque villa comprend trois chambres :
                deux chambres doubles avec salle de bain en suite, et une
                troisième chambre, adaptable en bureau selon vos besoins."
              </p>
            </div>
          </div>
        </div>
